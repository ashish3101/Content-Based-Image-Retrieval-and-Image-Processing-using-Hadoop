 ...
 */
public class Img2CannyEdge extends Configured implements Tool {
    public int run(String[] args) throws Exception {
        ...
        job.setMapperClass(Img2CannyEdgeMapper.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        int exitCode = ToolRunner.run(conf, new Img2CannyEdge(), args);
        System.exit(exitCode);
    }

    public static class Img2CannyEdgeMapper extends Mapper<NullWritable, MBFImageWritable,
